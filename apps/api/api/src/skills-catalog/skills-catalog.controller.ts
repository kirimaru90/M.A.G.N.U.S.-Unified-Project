...
import { SkillsCatalogPatchDto } from './dto/skills-catalog-patch.dto';
...
export class SkillsCatalogController {
  constructor(private readonly skillsCatalogService: SkillsCatalogService) {}
  ...
  @ApiOperation({
    summary: 'Batched add/update/rename/delete of skills catalog (admin)',
  })
  ...
  patchSchema(@Body() dto: SkillsCatalogPatchDto) {
    return this.skillsCatalogService.patchSchema(dto.ops);
  }
}
