...
CMS admin screens and API-client services for authoring the global skills and conditions catalogs via single batched `PATCH` calls, admin-only route guarding consistent with the rest of the CMS.
